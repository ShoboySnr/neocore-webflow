    ...
    request.onload = function () {
        ...
        if (request.status >= 200 && request.status < 400) {
            ...
            data.data.forEach((di, index) => {
                    ...
                    action_el.innerHTML = '<a href="javascript:void();" onclick="userPermissionsDetailsModalpopup(\'' + di.id +'\');" title="Update Permissions">Update Permissions</a> || <a href="javascript:void();" onclick="sendPasswordReset(\'' + di.email +'\');" title="Reset Password">Reset Password</a>';
