async function getSingleDepositAccount() {
    var myUrl = new URL(document.location.href)
    var id = myUrl.searchParams.get("id")

    let request = cbrRequest(`/deposit-account/${id}`, 'GET', true)
    ...
    if (request.status >= 200 && request.status < 400) {
        ...
        document.getElementById("button-edit-link").href = '/deposit-accounts/edit?id=' + deposit_product.id;
        ...
        field_liability_glid_el.textContent = deposit_product.liabilityGLId;
            ...
            document.location.href='/deposit-accounts/lists';
        }
