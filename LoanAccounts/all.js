...
async function filterDepositAccounts(event) {
    ...
    let request = await cbrRequest('/deposit-accounts?name='+ customer_name + '&nuban=' + nuban + '&product=' + product_name + '&status=' + account_status, 'GET', true);
...
async function getGLDepositAccounts(get_customers_account) {

    let request = await cbrRequest('/deposit-accounts', 'GET', true);
